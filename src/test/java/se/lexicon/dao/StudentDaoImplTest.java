...
class StudentDaoImplTest {
    ...
    Student student = new Student("Name", "name@test.com", "Address");
    ...
    @Test
    void findByEmail_mailexists_returnfirstfound() {
        studentDao.save(student);
    ...
    @Test
    void findByName_nameexists_returnnull() {
        studentDao.save(student);
    ...
    @Test
    void findById_idexists_returnnull() {
        studentDao.save(student);
